...
- **`test-matrix.yaml`** - Test case definitions
...
./test-automated-iteration.sh

# Test a specific distribution
./test-automated-iteration.sh ubuntu 24.04
./test-automated-iteration.sh rocky 9
```
...
./test-automated-iteration.sh --test-matrix my-tests.yaml fedora 43

# Keep VM on failure for debugging
./test-automated-iteration.sh --keep-on-failure ubuntu 24.04

# Limit iterations
./test-automated-iteration.sh --max-iterations 5 rocky 9

# Custom report directory
./test-automated-iteration.sh --report-dir ./my-reports fedora 43
```

## Test Matrix Format

The test matrix (`test-matrix.yaml`) defines test cases:
