...
<img src="docs/images/dashboard-screenshot.png" alt="ZTP Bootstrap Service Dashboard" style="box-shadow: 0 4px 8px rgba(0,0,0,0.2); border: 1px solid #ddd; border-radius: 4px;">
